        ...
        <div className="flex justify-between">
          <div className="flex space-x-7">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <a href="/commands/" className="py-4 px-2 text-white border-b-4 border-bookmark-red font-semibold hover:text-bookmark-red transition duration-300">Comandos</a>
